...
💡 If you need the wdio-v6 boilerplate project, please take the code from v6 branch: click [here](https://github.com/amiya-pattnaik/webdriverIO-with-jasmineBDD/tree/wdio-v6)
